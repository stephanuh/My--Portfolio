    ...
    return (
        <div className="about-container">
            ...
            <div className="about-image">
                <img src="public/images/profilePic.jpg" alt="Profile" />
            </div>
            <div className="about-text">
                <p>
                    Hello! Welcome to my Personal Site! My name is Stephanie and 
                    I am a full stack web developer looking for opportunities in the tech industry.
                    I have experience with HTML, CSS, JavaScript, and React, along with Node.js, Express, and SQL.  
                    I love solving problems and creating innovative web applications.
                ...
                <p>
                    If you would like to learn more about me, please feel free to reach out to me on LinkedIn or GitHub. 
